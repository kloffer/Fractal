...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/05/27 15:45:28 by ikachko           #+#    #+#             */
/*   Updated: 2018/05/27 15:45:28 by ikachko          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	calc_burningship(t_window *win)
{
										...
										&& win->it < win->it_max)
	{
		...
		win->z_re = (win->z_re * win->z_re
					- win->z_im * win->z_im) + win->c_re;
		win->z_im = (2 * fabs(win->z_im * win->tmp)) + win->c_im;
		win->it++;
	}
